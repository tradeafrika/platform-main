...
export default function DashboardLayout({
  ...
  const buyerNavItems: NavItem[] = [
    { title: "Home", href: "/dashboard/buyer/home", icon: Home },
    { title: "Marketplace", href: "/dashboard/buyer/marketplace", icon: Store },
    { title: "RFQs", href: "/dashboard/buyer/rfqs", icon: MessageSquare },
    { title: "Orders", href: "/dashboard/buyer/orders", icon: ShoppingBag },
    { title: "Invoices", href: "/dashboard/buyer/invoices", icon: FileText },
    { title: "Saved", href: "/dashboard/buyer/saved", icon: ShoppingCart },
    { title: "Settings", href: "/dashboard/buyer/settings", icon: Settings },
  ]

  const sellerNavItems: NavItem[] = [
    { title: "Home", href: "/dashboard/seller/home", icon: Home },
    { title: "Products", href: "/dashboard/seller/products", icon: Package },
    { title: "RFQs", href: "/dashboard/seller/rfqs", icon: MessageSquare },
    { title: "Orders", href: "/dashboard/seller/orders", icon: ShoppingBag },
    { title: "Invoices", href: "/dashboard/seller/invoices", icon: FileText },
    { title: "Transactions", href: "/dashboard/seller/transactions", icon: FileText },
    { title: "Analytics", href: "/dashboard/seller/analytics", icon: FileText },
      ...
      <aside className="hidden md:flex w-64 flex-col border-r bg-white dark:bg-gray-950 dark:border-gray-800">
        ...
        <nav className="flex-1 overflow-auto py-4">
          <div className="px-4 mb-4">
            <Button variant="outline" className="w-full justify-start gap-2 bg-transparent" onClick={toggleRole}>
              {role === "buyer" ? (
                <>
