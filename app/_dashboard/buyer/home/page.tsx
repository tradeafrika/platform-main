      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">3 awaiting your response</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+4 new verified suppliers</p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="overview" className="space-y-4">
            ...
            <Card className="col-span-4">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-4 rounded-md border p-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium">Invoice #INV-001 paid</p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track your expected shipments</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <div className="rounded-md border p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="font-medium">Aug 2, 2023</p>
                  </div>
                  <p className="mt-2 font-medium">Premium Coffee Beans</p>
                  <p className="text-sm text-muted-foreground">100kg - Highland Coffee Co.</p>
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center gap-2">
                    <Calendar className="h-4 w-4 text-primary" />
                    <p className="font-medium">Aug 5, 2023</p>
                  </div>
                  <p className="mt-2 font-medium">Organic Shea Butter</p>
                  <p className="text-sm text-muted-foreground">50kg - Ghana Natural Products</p>
                  <div className="mt-3 flex items-center gap-2">
                    <div className="h-2 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center gap-2">
                    <Calendar className="h-4 w-4 text-primary" />
                    <p className="font-medium">Aug 10, 2023</p>
                  </div>
                  <p className="mt-2 font-medium">Handwoven Textiles</p>
                  <p className="text-sm text-muted-foreground">20 units - Artisan Textiles Ltd</p>
                  <div className="mt-3 flex items-center gap-2">
                    <div className="h-2 w-full rounded-full bg-gray-200 dark:bg-gray-700">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center">
              <div className="flex-1">
                ...
                <CardDescription>Your procurement spending by category</CardDescription>
              </div>
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Cocoa Beans - 500kg</p>
                    </div>
                    <div className="text-right">
                      <p className="font-medium">Target: $15.00/kg</p>
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Palm Oil - 1000L</p>
                    </div>
                    <div className="text-right">
                      <p className="font-medium">Target: $8.50/L</p>
                ...
                <div className="rounded-md border p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Baobab Fruit Powder - 200kg</p>
                    </div>
                    <div className="text-right">
                      <p className="font-medium">Target: $30.00/kg</p>
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">45% of total spending</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader className="pb-2">
